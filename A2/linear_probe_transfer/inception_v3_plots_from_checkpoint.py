...
# CONFIG
# ----------------------------
CHECKPOINT_PATH = "inception_v3_aid.pth"
...
class FeatureExtractor(nn.Module):
    def __init__(self, model):
        ...
        self.model = model
        self._features = None
        self._hook_handle = self.model.avgpool.register_forward_hook(self._save_features)

    def _save_features(self, module, input, output):
        # avgpool output is (N, 2048, 1, 1); flatten to (N, 2048)
