...
class EfficientNetB0FewShotLearningAnalysis:
    ...
    def train_efficientnet_b0(self, data_percentage=100, epochs=20, lr=0.001):
        """Train EfficientNet-B0 with specified data percentage."""
    ...
    def analyze_few_shot_learning(self):
        ...
        for pct in tqdm(percentages, desc="Few-shot regimes"):
            ...
            model, results = self.train_efficientnet_b0(data_percentage=pct)
...
analyzer = EfficientNetB0FewShotLearningAnalysis(seed=42)
